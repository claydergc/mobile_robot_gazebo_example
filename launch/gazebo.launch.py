...
def generate_launch_description():
    ...
    models_path = join(get_package_share_directory("mobile_robot_gazebo_example"), "worlds_and_models")
    ...
    gazebo_sim = IncludeLaunchDescription(path,
                                          ...
                                          launch_arguments=[("gz_args", '-r /home/user/ros2_ws/src/mobile_robot_gazebo_example/worlds_and_models/cafe.sdf')])
    ...
    arguments=['/model/krytn/cmd_vel@geometry_msgs/msg/Twist@gz.msgs.Twist',
                   ...
                   output='screen', remappings=[('/model/krytn/odometry','/odom'),
                    ('/model/krytn/tf','/tf'),('/model/krytn/cmd_vel','/cmd_vel')]
    )
    ...
    #return LaunchDescription([gazebo_sim, bridge, robot, robot_state_publisher, with_sensors_arg])
    return LaunchDescription([gazebo_sim, extended_bridge, robot, robot_state_publisher, with_sensors_arg])
    #return LaunchDescription([bridge, robot, robot_state_publisher, with_sensors_arg])
