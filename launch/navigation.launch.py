...
def generate_launch_description():
    ...
    base_path = get_package_share_directory("mobile_robot_gazebo_example")
    ...
    navigation = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'use_sim_time': 'true',
            'params_file': get_package_share_directory('mobile_robot_gazebo_example') + '/config/navigation.yaml'
        }.items()
    )
